# VMWare SVGA II
It is a virtual graphics card provided in VMWare emulators and possibly others. It supports high resolution, 32bit color, 2D & 3D acceleration runnion on top of the host's card. Has a linear framebuffer. It behaves as a PCI device.
...
- FB_START (Framebuffer start): `0x0d`
- FB_OFFSET (Framebuffer padding): `0x0e`
- FB_SIZE (Framebuffer size): `0x10`
...
- Writting values directly to framebuffer memory should be reflected on the screen
